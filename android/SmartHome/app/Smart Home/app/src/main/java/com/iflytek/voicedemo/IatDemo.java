...
import com.iflytek.voicedemo.IatSettings;
import com.iflytek.voicedemo.util.ApkInstaller;
import com.iflytek.voicedemo.util.FucUtil;
import com.iflytek.voicedemo.util.JsonParser;
import com.iflytek.sunflower.FlowerCollector;

import com.mindcont.SmartHome.MainActivity;
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    myMainActivity.refreshView(bytes); // 刷新界面
                    break;
...
//        if(resultBuffer.toString().equals(lightON)){
//
